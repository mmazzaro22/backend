...
// StripeCheckoutObjectConstruct defines type to store the "stripeCheckoutObject" construct.
type StripeCheckoutObjectConstruct struct {
	Id  string `json:"id" yaml:"id" schema:"id"  db:"id" csv:"id""`
	Url string `json:"url" yaml:"url" schema:"url"  db:"url" csv:"url""`
}

// StripeAccessTokenConstruct defines type to store the "stripeAccessToken" construct.
type StripeAccessTokenConstruct struct {
